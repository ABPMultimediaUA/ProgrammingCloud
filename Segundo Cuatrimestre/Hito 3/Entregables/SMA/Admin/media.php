...
<?php
    ...
    function mostrarFotos(){
        $handle = opendir(dirname(realpath(__FILE__)).'/images/usuarios');
        while($file = readdir($handle)){
            if($file !== '.' && $file !== '..'){
                echo '<img src="images/usuarios/'.$file.'" border="0" height="140" width="140"/>';
            }
        }
    }

    function mostrarFotos2(){
        $handle = opendir(dirname(realpath(__FILE__)).'/images/cursos');
        while($file = readdir($handle)){
            if($file !== '.' && $file !== '..'){
                echo '<img src="images/cursos/'.$file.'" border="0" height="140" width="140"/>';
            }
        }
    }
 ?>
