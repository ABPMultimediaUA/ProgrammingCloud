                ...
                <br>
                    <form id="tab" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea form="tab" name="solucion" class="form-control" rows="6" required></textarea>
                        </div>
                        <div class="form-group">
...
<?php  
    ...
    function addLeccion(){
        ...
        $sql="INSERT INTO leccion (Id, Titulo, Contenido, Solucion, Orden_Int, Id_Curso) VALUES (NULL, '$_POST[titulo]', '$_POST[contenido]', '$_POST[solucion]', '0', '$_POST[curso]')";
