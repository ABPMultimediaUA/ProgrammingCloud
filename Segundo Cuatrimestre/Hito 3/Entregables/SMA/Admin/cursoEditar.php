                ...
                <br>
                    <form id="tab" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                                ...
                                <input type="number" name="descuento" class="form-control" min="0" max="100" step="10" value="<?php if(isset($curs)) echo $descuento; ?>">
                        </div>
...
<?php  
    ...
    function editarCurso($curso){
        ...
        if($imageType!=""){
            ...
            $sql="UPDATE curso SET Titulo='$_POST[titulo]', Descripcion = '$_POST[descr]', Nivel = '$_POST[nivel]', Foto = '$imageType', Precio = '$_POST[precio]', Descuento = '$_POST[descuento]', Visible = '$publ', Adm_Email='$_SESSION[email]' WHERE curso.Id = '$curso'";
        }else{
            $sql="UPDATE curso SET Titulo='$_POST[titulo]', Descripcion = '$_POST[descr]', Nivel = '$_POST[nivel]', Precio = '$_POST[precio]', Descuento = '$_POST[descuento]', Visible = '$publ', Adm_Email='$_SESSION[email]' WHERE curso.Id = '$curso'";
        }
