                ...
                <br>
                    <form id="tab" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                                ...
                                <input type="number" name="descuento" class="form-control" min="0" max="100" step="10" value="0">
                        </div>
...
<?php  
    ...
    function addCurso(){
        ...
        if($imageType!=""){
                ...
                $sql="INSERT INTO curso (Id, Titulo, Descripcion, Nivel, Tema, Foto, Precio, Descuento, Visible, Adm_Email) VALUES (NULL, '$_POST[titulo]', '$_POST[descr]', '$_POST[nivel]', '', '$imageType', '$_POST[precio]', '$_POST[descuento]', '$publ', '$_SESSION[email]' )";
        }else{
                $sql="INSERT INTO curso (Id, Titulo, Descripcion, Nivel, Tema, Foto, Precio, Descuento, Visible, Adm_Email) VALUES (NULL, '$_POST[titulo]', '$_POST[descr]', '$_POST[nivel]', '', NULL, '$_POST[precio]', '$_POST[descuento]', '$publ', '$_SESSION[email]' )";
        }
